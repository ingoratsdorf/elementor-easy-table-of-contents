<?php
/**
 * Plugin Name: Elementor Easy Table of Contents
 * Description: Proof of concept to show value of creating an Elementor Widget for Easy Table of Contents. Its based on Elementors Hello World example plugin code.
 * Plugin URI:  
 * Version:     1.1.0
 * Author:      Sil 
 * Author URI:  
